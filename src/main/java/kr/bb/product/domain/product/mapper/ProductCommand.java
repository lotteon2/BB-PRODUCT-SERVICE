...
public class ProductCommand {
    ...
    public static ProductThumbnail getProductThumbnailData(Product byProductId) {
        return ProductThumbnail.builder().productThumbnail(byProductId.getProductThumbnail())
                .build();
    }
                        ...
                        .map(
                                item ->
                                        CartProductItemInfo.builder()
                                                ...
                                                .freeDeliveryMinCost(storePolicies.get(item)
                                                        .getFreeDeliveryMinCost())
                                                .deliveryCost(
                                                        storePolicies.get(item).getDeliveryCost())
                                                .productInfoList(
                                                        ProductCommand.getProductInfoDtoForCart(
                                                                productsByProductIdsForCartItem.get(
                                                                        item), productIds))
                                                .build())
                        .collect(Collectors.toList());
    ...
    public static class ProductListItem {
        ...
        public static List<String> getProductIds(List<ProductListItem> productListItem) {
            return productListItem.stream().map(ProductListItem::getKey)
                    .collect(Collectors.toList());
        }
    ...
    public static class ProductList {
        ...
        public static ProductList getData(List<ProductListItem> productListItem,
                long totalElements) {
            return ProductList.builder().products(productListItem).totalCnt(totalElements).build();
        }
    }
    ...
    public static class MainPageProductItems {
        ...
        public static MainPageProductItems getData(
            ...
            return MainPageProductItems.builder()
                    .products(
                            items.stream()
                                    .peek(item -> item.setLiked(
                                            productsIsLiked.contains(item.getKey())))
                                    .collect(Collectors.toList()))
                    .build();
        }
    ...
    public static class SubscriptionProductForCustomer {
        ...
        public static SubscriptionProductForCustomer getData(
            ...
            SubscriptionProductForCustomer product =
                    ProductMapper.INSTANCE.getSubscriptionProductDetail(
